      ...
      case 'soundcloud':
        return (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" style={{ display: 'block' }}>
            <path d="M19.5 9c-1.4 0-2.5 1.1-2.5 2.5v1h-8c0-2.8 2.2-5 5-5 .8 0 1.5.2 2.1.5.3-.7.9-1.2 1.6-1.5.7-.3 1.5-.2 2.1.2.4-.1.8-.2 1.2-.2 1.9 0 3.5 1.6 3.5 3.5 0 .2 0 .4-.1.6.3.1.6.3.8.5.1-.1.2-.3.2-.5 0-.6-.5-1-1-1-.1 0-.2 0-.3.1zm.5 1.5c0-.3.2-.5.5-.5s.5.2.5.5v1c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-1zm-2 0c0-.3.2-.5.5-.5s.5.2.5.5v1.5c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-1.5zm-2-.5c0-.3.2-.5.5-.5s.5.2.5.5v2c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-2zm-2-.5c0-.3.2-.5.5-.5s.5.2.5.5v2.5c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-2.5zm-2-.5c0-.3.2-.5.5-.5s.5.2.5.5v3c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-3zm-2-.5c0-.3.2-.5.5-.5s.5.2.5.5v3.5c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-3.5zm-2-.5c0-.3.2-.5.5-.5s.5.2.5.5v4c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-4zm-2-.5c0-.3.2-.5.5-.5s.5.2.5.5v4.5c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-4.5z" fill="#FF6B00" style={{ filter: 'drop-shadow(0 0 4px rgba(255, 107, 0, 0.6))' }}/>
