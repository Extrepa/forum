            ...
            >
              <div className="account-profile-preview-left-column">
                <div className="account-profile-header-group">
                  ...
                  <Username name={user.username} colorIndex={getUsernameColorIndex(user.username, { preferredColorIndex: user.preferred_username_color_index })} avatarKey={undefined} href={null} style={{ fontSize: 'clamp(18px, 4vw, 26px)', fontWeight: '700', wordBreak: 'normal', overflowWrap: 'anywhere', maxWidth: '100%', display: 'inline-block', lineHeight: '1.2' }} />
