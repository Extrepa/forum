            ...
            >
              <div className="account-profile-preview-left-column">
                <div className="account-profile-header-group">
                  ...
                  <Username name={user.username} colorIndex={getUsernameColorIndex(user.username, { preferredColorIndex: user.preferred_username_color_index })} avatarKey={undefined} href={null} style={{ fontSize: 'clamp(20px, 4.5vw, 26px)', fontWeight: '700', overflowWrap: 'break-word', wordBreak: 'normal', maxWidth: '100%', display: 'inline-block', lineHeight: '1.2' }} />
