...
export default async function TimelineDetailPage({ params, searchParams }) {
    ...
    <div className="stack">
      <Breadcrumbs
        items={[
          ...
          { href: `/timeline/${update.id}`, label: update.title || 'Update' },
        ]}
      />
      ...
      <section className="card">
        ...
        {update.image_key ? (
          <img src={`/api/media/${update.image_key}`} alt="" className="post-image" loading="lazy" />
        ) : null}
