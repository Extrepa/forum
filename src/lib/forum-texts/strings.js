export const errlForumStrings = {
  ...
  hero: {
    ...
    greetingSuffix: '.',
    // For plain-string contexts.
    greetingWithUser: 'Welcome back, {username}.',
  ...
  easterEggs: [
    ...
    'You are now entering: Slightly Weird Territory.',
    'Warning: Creative residue present.'
  ],
  loreAlternatives: {
    header: {
